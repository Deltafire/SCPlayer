...
#define WrZ80(A,B) Z80_WRMEM(R->User,A,B)
#define RdZ80(A) Z80_RDMEM(R->User,A)
void Z80_WRMEM(void *User, register word Addr,register byte Value);
byte Z80_RDMEM(void *User, register word Addr);
...
/************************************ TO BE WRITTEN BY USER **/
#define OutZ80(A,B) Z80_Out(R->User,A,B)
#define InZ80(A) Z80_In(R->User,A)
void Z80_Out(void *user, register word Port,register byte Value);
byte Z80_In(void *User, register word Port);
